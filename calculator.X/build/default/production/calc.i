...
void lcdinit(){
 _delay((unsigned long)((400)*(20e6/4000.0))); lcdcmd(0x30); _delay((unsigned long)((400)*(20e6/4000.0))); lcdcmd(0x30);
_delay((unsigned long)((400)*(20e6/4000.0))); lcdcmd(0x30); _delay((unsigned long)((400)*(20e6/4000.0))); lcdcmd(0x38);
    lcdcmd(0x0F);
    lcdcmd(0x01);
    lcdcmd(0x06);
    lcdcmd(0x80);
...
void main (void)
  {
   ...
   TRISB=0x00;
      TRISD6=0;
      TRISD7=0;
   _delay((unsigned long)((400)*(20e6/4000.0)));
...
void lcdcmd(unsigned char value)
  {
    ...
    RD6 = 0;
    RD7 = 1;
    _delay((unsigned long)((100)*(20e6/4000.0)));
    RD7 = 0;
    _delay((unsigned long)((100)*(20e6/4000.0)));
  }
...
if(RC4==1 ){ lcddata('7');_delay((unsigned long)((500)*(20e6/4000.0)));d= '7';c='a';}
if(RC5==1 ){ lcddata('8');_delay((unsigned long)((500)*(20e6/4000.0)));d= '8';c='a';}
if(RC6==1 ){ lcddata('9');_delay((unsigned long)((500)*(20e6/4000.0)));d= '9';c='a';}
if(RC7==1 ){ lcddata('/');_delay((unsigned long)((500)*(20e6/4000.0)));d= '/';c='a';}

RC0=0;RC1=1;RC2=0;RC3=0;

if(RC4==1 ){ lcddata('4');_delay((unsigned long)((500)*(20e6/4000.0)));d= '4';c='a';}
if(RC5==1 ){ lcddata('5');_delay((unsigned long)((500)*(20e6/4000.0)));d= '5';c='a';}
if(RC6==1 ){ lcddata('6');_delay((unsigned long)((500)*(20e6/4000.0)));d= '6';c='a';}
if(RC7==1 ){ lcddata('*');_delay((unsigned long)((500)*(20e6/4000.0)));d= '*';c='a';}

RC0=0;RC1=0;RC2=1;RC3=0;

if(RC4==1 ){ lcddata('1');_delay((unsigned long)((500)*(20e6/4000.0)));d= '1';c='a';}
if(RC5==1 ){ lcddata('2');_delay((unsigned long)((500)*(20e6/4000.0)));d= '2';c='a';}
if(RC6==1 ){ lcddata('3');_delay((unsigned long)((500)*(20e6/4000.0)));d= '3';c='a';}
if(RC7==1 ){ lcddata('-');_delay((unsigned long)((500)*(20e6/4000.0)));d= '-';c='a';}

RC0=0;RC1=0;RC2=0;RC3=1;

if(RC5==1 ){ lcddata('0');_delay((unsigned long)((500)*(20e6/4000.0)));d= '0';c='a';}
if(RC7==1 ){ lcddata('+');_delay((unsigned long)((500)*(20e6/4000.0)));d= '+';c='a';}
}
return d;
}
...
_delay((unsigned long)((3000)*(20e6/4000.0)));
lcdcmd(0x01);
}
